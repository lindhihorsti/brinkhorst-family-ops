...
class ShoppingListItem(SQLModel, table=True):
    ...
    pantry_name: Optional[str] = Field(default=None, sa_column=Column(String, nullable=True))
    pantry_uncertain: bool = Field(default=False, sa_column=Column(Boolean, nullable=False, server_default=text("false")))
